...
# The board given a move will update the pieces and positions that are impacted by that move

# The board keeps state of certain multi piece actions, such as castling 
# 
#The board can return a piece at a given position